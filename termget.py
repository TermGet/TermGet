...
if package != "pip":
    while True: #Starts a loop
        ...
        if user == "1": #Search
            ...
            elif package == "pacman": user1 = input("Which package manager would you like to use?\n\n1. pacman\n2. yaourt\n")
        ...
        if user == "2": #Install
            ...
            if package == "xbps": os.system("sudo xbps-install " + user)
            if package == "dnf": os.system("sudo dnf install " + user)
            if package == "zypper": os.system("sudo zypper install " + user)
            if package == "eopkg": os.system("sudo eopkg install " + user)
            input("\nPress enter to continue")
        ...
        if user == "3": #Remove
            ...
            if package == "pacman": os.system("sudo pacman -Rs " + user)
            if package == "xbps": os.system("sudo xbps-remove " + user)
            if package == "dnf": os.system("sudo dnf remove " + user)
            if package == "zypper": os.system("sudo zypper remove " + user)
            if package == "eopkg": os.system("sudo eopkg remove " + user)
            input("\nPress enter to continue")
        ...
        if user == "4": #Updates Packages
            ...
            if package == "pacman": os.system("sudo pacman -Syu")
            if package == "xbps": os.system("sudo xbps-install -Su")
            if package == "dnf":
            ...
            if package == "eopkg": os.system("sudo eopkg upgrade")
            input("\nPress enter to continue")
